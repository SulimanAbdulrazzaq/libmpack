...
#define DF(g, s) {                                           \
  ...
  F("-4294967301", 0xd3, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xff, 0xfb),
...
const struct fixture number_fixtures[] = {
  ...
  F("4294967296", 0xcf, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00),
  F("9007199254740991", 0xcf, 0x00, 0x1f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff),
  F("9007199254740992", 0xcf, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
  /* largest double below 2^64 */
  F("1.844674407370955e+19", 0xcf, 0xff, 0xff, 0xff, 0xff,
                                   0xff, 0xff, 0xf8, 0x00),
  /* 2^64 and above can only be packed as floats */
  F("1.8446744073709552e+19", 0xca, 0x5f, 0x80, 0x00, 0x00),
  F("1.0000000000000001e+300", 0xcb, 0x7e, 0x37, 0xe4, 0x3c,
                                     0x88, 0x00, 0x75, 0x9c),
  F("-128", 0xd0, 0x80),
  F("-127", 0xd0, 0x81),
  F("-32768", 0xd1, 0x80, 0x00),
  ...
  F("-4294967296", 0xd3, 0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00),
  F("-4294967301", 0xd3, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xff, 0xfb),
  F("-12884971888", 0xd3, 0xff, 0xff, 0xff, 0xfc, 0xff, 0xfe, 0xee, 0x90),
  F("-9007199254740991", 0xd3, 0xff, 0xe0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01),
  F("-9007199254740992", 0xd3, 0xff, 0xe0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00),
  F("-9.2233720368547758e+18", 0xd3, 0x80, 0x00, 0x00, 0x00,
                                     0x00, 0x00, 0x00, 0x00),
  /* below -2^63 can only be packed as floats */
  F("-9.2233720368547779e+18", 0xcb, 0xc3, 0xe0, 0x00, 0x00,
                                     0x00, 0x00, 0x00, 0x01),
  F("-32", 0xe0),
  F("-31", 0xe1),
  F("-30", 0xe2),
